...
describe('ReadAdsViewComponentInternal', () => {
  ...
  it('renders ads correctly', () => {
    const productAds = [
      { id: 1, title: 'Ad 1', description: 'Description 1', image: 'image1.jpg' },
      { id: 2, title: 'Ad 2', description: 'Description 2', image: 'image2.jpg' },
    ];
    const productId = '123';

    const { getByText } = render(
      <ReadAdsViewComponentInternal productAds={productAds} productId={productId} />
    );
  ...
  it('calls addAdForProduct when Quick Add Ad button is clicked', () => {
    const productAds = [];
    const productId = '123';
    ...
    expect(useAdsContext().addAdForProduct).toHaveBeenCalledWith(productId, {
  ...
  it('calls deleteAdById when Delete button is clicked', () => {
    const productAds = [{ id: 1, title: 'Ad 1', description: 'Description 1', image: 'image1.jpg' }];
    const productId = '123';
